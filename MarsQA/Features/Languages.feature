...
Scenario Outline: D. Create a Language Record with incomplete data
Given I navigate to Languages Tab
...
Scenario Outline: G. Edit a Language Record with partial values
Given I navigate to Languages Tab
...
Scenario: H. Once the fourth language is created Add New button should be invisible
Given I navigate to Languages Tab
...
Scenario Outline: J. Create a Language Record with many characters
Given I navigate to Languages Tab
